...
def fetch_block_geometry(repo: Repository, document_id: str):
...
def compute_columns(repo: Repository, document_id: str):
...
def persist_columns(repo: Repository, column_map):
...
def compute_and_store_columns(repo: Repository, document_id: str):
